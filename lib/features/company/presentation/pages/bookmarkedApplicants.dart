...
import 'package:dubai_recruitment/features/company/presentation/pages/companyBookmarks.dart';
import 'package:dubai_recruitment/features/job/presentation/pages/jobsPosted.dart';
import 'package:flutter/material.dart';

import '../../../../core/widgets/appBar.dart';

class BookmarkedApplicantsView extends StatefulWidget {
  const BookmarkedApplicantsView({super.key});

  @override
  State<BookmarkedApplicantsView> createState() =>
      _BookmarkedApplicantsViewState();
}

class _BookmarkedApplicantsViewState extends State<BookmarkedApplicantsView> {
                ...
                children: [
                  ...
                  ...companies.map(
                    (e) => ListTile(
                      ...
                      onTap: () {
                        context.navigateTo(CompanyBookmarksView(company: e));
                      },
                      leading: Container(
                        height: 50,
                        width: 50,
